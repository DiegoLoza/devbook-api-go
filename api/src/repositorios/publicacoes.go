...
// NovoRepositórioDePublicacoes cria um repositório de publicacoes
...
// Atualizar os dados de uma publicação no banco de dados
...
// Deletar exclui uma publicacoes do banco de dados
