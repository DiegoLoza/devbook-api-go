...
// BuscarPublicações traz as publicações que apareciam no feed do usuário
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != usuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("Não é possivel atualizar uma publicacao que nao seja sua"))
		return
	}
